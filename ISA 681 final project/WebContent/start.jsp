...
<div class="left_content">
             <% 
            	...
            	<div class="calendar_box2">
                    ...
                    if((String)request.getParameter("betting")!=null)
                    {
                   
               			String bet=(String)request.getParameter("betting");
               			
  							System.out.println("betting value transferred "+bet);
               			  session.setAttribute("bet2",bet);
                    }
                     %>
                    

 
                    ENTER A BETTING VALUE:
 					 <input type="number" name="betting" min="1" max="100" value="50">
  					</td>
