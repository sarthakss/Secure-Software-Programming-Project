 ...
 <li><a href="register.jsp" class="nav">Registration</a></li>
            ...
            <div class="left_content">
            	...
            	<div>
					...
					<input type="text" required  name="username" onkeyup="sendInfo() "/></td></tr>
					<tr><td><br/> </td></tr>		
					
					<tr><td>Password:</td><td>
					<input type="password" required name="userpass"/></td></tr>
					<tr><td><br/> </td></tr>	
					...
					<tr><td>Email:</td><td>
					<input type="email" required name="email"/></td></tr>	
					<tr><td><br/> </td></tr>			
					<tr><td>      </td>
